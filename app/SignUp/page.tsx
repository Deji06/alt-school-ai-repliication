  ...
  return (
    <div className="px-4 py-4 sm:px-0 sm:py-0 mt-10 mx-">
      ...
      <div className="mx-10">
        ...
        <form action="" className="flex flex-col gap-y-5 mt-5" onSubmit={handleForm}>
        ...
        <button type="submit"  className="text-white bg-[#2F80ED] px-5 py-2 rounded-[10px] mt-5">sign up</button>
